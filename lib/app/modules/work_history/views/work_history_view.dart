...
class AttendanceListView extends StatelessWidget {
  ...
  final WorkHistoryController controller =
            ...
            Expanded(
              child: Obx(() {
                if (controller.isLoading.value) {
                  ...
                  ListView.builder(
                    itemCount: 5,
                    itemBuilder: (context, index) => ShimmerWidgets.shimmerCard(height: 80),
                  );
                }
...
class WorkDetailPage extends StatelessWidget {
  final List workInfo;
   WorkDetailPage({super.key, required this.workInfo});
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            title: Text(field.field,style: titleTextBlue16,),
